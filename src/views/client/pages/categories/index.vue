...
const priceRange = ref(['Tất cả', 'Dưới $20', '$25 đến $100', '$300 đến $500', '$500 đến $1,000', '$1,000 đến $10,000']);
...
const brands = ref(['SaiGon Petro', 'AP Oil', 'Sino', 'Polaris', 'Singtec', 'Export & Toll Blending']);
    ...
    <div class="bg-white">
        <div class="grid container mx-auto">
            <div class="col-3 pl-0">
                <div>
                    ...
                    <div v-for="(item, index) in categories" :key="index">
                        <div class="mb-3">
                            <RadioButton v-model="categoryChecked" :inputId="`categoryChecked${index + 1}`"
                                name="category" :value="item" />
                            <label :for="`categoryChecked${index + 1}`"
                                class="ml-2 gray-color-4 hover:text-green-600">{{ item }}</label>
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div class="mt-4">
                    <div v-for="(item, index) in priceRange" :key="index">
                        <div class="mb-2">
                            <RadioButton v-model="priceRangeChecked" :inputId="`priceRangeChecked${index + 1}`"
                                name="priceRange" :value="item" pt:input:class="bg-orange-500" />
                            <label :for="`priceRangeChecked${index + 1}`"
                                class="ml-2 gray-color-4 hover:text-green-600">{{ item }}</label>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="" v-for="(item, index) in brands" :key="index">
                        <div class="mt-2">
                            <TriStateCheckbox :model="brandsChecked.includes(item)" @change="updateChecked(index)"
                                variant="filled" />
                ...
                <div class="p-3 border-3" style="border-color: #ffe7d6">
                    ...
                    <div class="flex flex-column justify-content-center align-items-center">
                        ...
                        <span class="mt-3">Only for: <button
                                class="font-semibold py-2 px-3 border-none border-round-sm ml-1"
                                style="background-color: #f3de6d">$299 USD</button></span>
            ...
            <div class="col-9 pr-0">
                <div class="flex justify-content-between">
                    <div class="w-30rem">
                        <IconField iconPosition="right">
                            ...
                            <InputText class="w-30rem" v-model="value1" placeholder="Tìm kiếm sản phẩm..." />
                        </IconField>
                    </div>
                    <div>
                ...
                <div>
                    <div class="grid mt-4">
                        <div class="col-3 p-2" v-for="(item, index) in products" :key="index">
                            <div class="p-3 border-1 border-round-md hover:shadow-2 item-container"
                                style="border-color: #cbd5e1;">
                                <div class="mb-2 image-wrapper">
                                    <img :src="item.image" alt="" style="width: 216px; height: 188px" />
                                ...
                                <div class="flex flex-column">
                                    <span class="flex size-12px my-2">
                                        ...
                                        <span class="ml-2">({{ item.voted }})</span>
                                    </span>

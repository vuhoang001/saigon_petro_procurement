    ...
    <div class="grid mt-4 flex justify-content-around">
      <div class="col-4 p-0 bg-white w-22rem border-1 border-solid border-gray-200 border-round-md">
        ...
        <div class="ml-3 mt-3">
          ...
          <div class="flex flex-column">
            ...
            <label class="my-1 text-gray-500"><label for="" class="font-medium text-gray-900">Sec Email:</label>
              minhdang1102@gmail.com</label>
            <label class="my-1 text-gray-500"><label for="" class="font-medium text-gray-900">Số điện thoại:</label>
              153.426.157</label>
          </div>
      ...
      <div class="col-4 bg-white p-0 w-22rem border-1 border-solid border-gray-200 border-round-md">
        ...
        <div class="mx-3 mt-3">
          ...
          <div class="flex flex-column">
            <label class="my-1 text-gray-500">Số 12, Hẻm 12 Nguyễn Thị Minh Khai, Phường Hai Bà Trưng, Quận 1, Thành phố
              Hồ Chí Minh</label>
            <label class="my-1 text-gray-500"><label for="" class="font-medium text-gray-900">Sec Email:</label>
              minhdang1102@gmail.com</label>
            <label class="my-1 text-gray-500"><label for="" class="font-medium text-gray-900">Số điện thoại:</label>
      ...
      <div class="col-4 p-0 w-22rem flex flex-column justify-content-between">
        ...
        <div class="bg-orange-100 border-round-sm p-3">
          <div class="flex">
            <i class="fa-regular fa-newspaper p-3 bg-white border-round-sm text-3xl mr-3 text-orange-300"></i>
            <div class="flex flex-column justify-content-around">
        ...
        <div class="bg-green-100 border-round-sm p-3">
          <div class="flex">
            <i class="fa-solid fa-box-archive p-3 bg-white border-round-sm text-3xl mr-3 text-green-300"></i>
            <div class="flex flex-column justify-content-around">
    ...
    <div class="border-1 border-round-md border-solid border-gray-200 mt-4 bg-white">
      <div class="font-medium border-bottom-1 border-gray-200 bg-white">
        <div class="mx-3 mt-4 flex justify-content-between">
          ...
          <a href="" class="text-orange-400 hover:underline">Xem tất cả <i class="fa-solid fa-arrow-right ml-2"></i></a>
        </div>
      </div>

      <div>
        <DataTable :value="products" header="surface-200" :rowStyleClass="getRowClass" tableStyle="min-width: 50rem">
        ...
        <div class="grid flex justify-content-between">
          <div v-for="item in searchProducts"
            ...
            <div class="px-3 mt-2">
              ...
              <div class="my-2 text-base font-medium cursor-pointer hover:underline" for="">
                {{ item.title }}
              </div>

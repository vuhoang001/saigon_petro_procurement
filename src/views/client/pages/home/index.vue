...
<template>
  <div class="container mx-auto">
    <div class="grid mx-0 my-0 border-round-sm">
      <div class="col-12 md:col-6 lg:col-8 bg-gray-200">
        <div class="flex mx-6">
          <div class="flex align-items-start flex-column justify-content-center">
            ...
            <button
              class="btn mt-4 border-none px-5 h-4rem"
              style="background-color: #f2ee1b"
            >
              <span class="font-bold pr-2"> Mua ngay </span>
              <svg
                class="pl-2 bg-green-300"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <div class="flex align-items-center relative">
            <img
              ...
              alt=""
              srcset=""
              style="height: 390px; width: 420px"
            />
            <div
      ...
      <div class="col-12 md:col-6 lg:col-4 px-0 py-0 flex flex-column">
        <div
          class="flex-1 mb-2 lg:ml-3 border-round-sm"
          style="background-color: #5c9c78"
        >
          <div class="mx-5 flex relative h-full align-items-center">
            <div class="">
              ...
              <div>
                <button
                  class="btn mt-3 border-none px-4 h-3rem"
                  style="background-color: #f2ee1b"
                >
                  <span class="font-bold pr-2"> Mua ngay </span>
                  <svg
            ...
            <div>
              ...
              />
              <span class="sale-off size-16px absolute" style="top: 25px; right: 0px"
                >-29% off</span
              >
            </div>
          </div>
  ...
  <div class="container mx-auto my-6">
    ...
    <div class="mt-5">
      <div class="grid">
        <div
          class="col-3 pt-0 pr-0"
          v-for="(item, index) in filteredProductMainFS"
          :key="index"
        >
          <div
            class="border-1 border-round-xs h-full"
          ...
          >
            <div class="p-4" bg-green-300>
              ...
              <div class="mt-4">
                <div class="flex justify-content-between">
                  <span
                    class="p-3 bg-green-300border-round-xs text-xl"
                    style="background-color: #ffe7d5"
                  >
                    <i class="fa-regular fa-heart"></i>
                  </span>
                  <span
                    class="text-white p-3 border-round-xs"
        ...
        <div class="col-9">
          <div class="grid">
            <div
              v-for="(item, index) in filteredSubProductMainFS"
              :key="index"
            ...
            >
              <div class="image-wrapper">
                ...
                <div class="overlay flex justify-content-center align-items-center">
                  <i
                    class="bg-white p-3 border-circle mx-2 fa-regular fa-heart"
                    style="font-size: 18px"
                  ></i>
                  <i
                    class="bg-white p-3 border-circle mx-2 fa-solid fa-cart-shopping"
                    style="font-size: 18px"
                  ></i>
                  <i
                    class="bg-orange-400 text-white p-3 border-circle mx-2 fa-regular fa-eye"
                    style="font-size: 18px"
                  ></i>
                </div>
              </div>
              <div class="flex flex-column">
                ...
                <span class="text-md blue-color"> $ {{ item.newPrice }} </span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container mx-auto my-6">
      ...
      <div class="flex justify-content-between my-6">
        ...
        >
          ...
          />
          <p
            class="text-center mt-2 mx-auto cursor-pointer hover:underline hidden-product-categories"
          >
            {{ company.companyName }}
          </p>
        </div>
        ...
        <div class="col-3 py-0">
          <div class="bg-yellow-300">
            <div class="flex flex-column text-center">
              <span class="text-sx mt-5 font-semibold" style="color: #be4646"
                >SUOERIOR SYNTHETIC MOTOR OIL</span
              >
              ...
              <button
                class="w-10rem py-3 my-3 border-none mx-auto size-16px text-white cursor-pointer"
        ...
        <div class="col-9 p-0">
          <div class="flex flex-wrap h-full">
            <div class="flex justify-content-between align-items-center w-full">
              ...
              <div>
                <span
                  class="ml-4 gray-color hover:text-gray-800 cursor-pointer"
            ...
            <div class="col-3 pb-0 pl-0" v-for="item in productsFeature" :key="item.name">
              <div
                class="h-full p-1 border-1 border-solid"
                style="border-color: var(--surface-border)"
              >
          ...
          <div class="col-6" style="">
            <div class="flex" style="background-color: #f2f4f5">
              <div class="flex flex-column w-6 p-5">
                <span
                  class="px-3 py-2 bg-blue-300 w-6rem text-center"
            ...
            <div class="">
              <div class="flex" style="background-color: #191c1f">
                <div class="flex flex-column w-6 p-5 text-white">
                  <span
                    class="px-3 py-2 bg-blue-300 w-6rem text-center text-gray-800 bg-yellow-300"
                    style="border-radius: 4px"
                    >Mới về</span
                  >

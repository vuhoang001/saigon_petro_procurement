...
<template>
    <div class="mx-7 mt-6">
        <div class="grid">
            <div class="col-9">
                <div class="mx-3 px-3 py-3 bg-white font-medium text-lg">Số lượng (2)</div>

                <div class="mx-3 mt-4 px-3 py-3 bg-white">
                    <div class="flex justify-content-between text-lg">
                        <label for="">#1</label>
                        <label for="">
                            <i class="fa-regular fa-pen-to-square"></i>
                            <i class="fa-regular fa-trash-can ml-3"></i>
                        </label>
                    </div>
                    <div class="grid mt-2">
                        <div class="col-2">
                            <div class="bg-gray-100 py-3 text-center border-round-md mx-4">
                                <img class="w-auto h-6rem" :src="objCart.image" alt="img" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-2xl font-bold">{{ objCart.name }}</div>
                            <div class="mt-3 mb-2 text-lg">{{ objCart.price }}.000 đ</div>
                            <InputGroup class="h-3rem w-5">
                                <Button icon="fa-solid fa-minus" style="background-color: white; color: black" @click="count--" />
                                <InputText v-model="objCart.quantity"></InputText>
                                <Button icon="fa-solid fa-plus" style="background-color: white; color: black" @click="increaseCount" />
                            </InputGroup>
                        </div>
                        <div class="col-4 text-right text-lg font-bold">Tổng cộng: {{ objCart.quantity * objCart.price }}.000 đ</div>
                        <div class="ml-3">
                            <Accordion>
            ...
            <div class="col-3">
                <div class="bg-white px-5 py-3">
                    ...
                    <div class="flex justify-content-between font-bold text-lg mt-5">
                        ...
                        <label for="">19.740.000 đ</label>
                    </div>
                    <div style="height: 1px; background-color: black; margin: 10px 0"></div>
                    <Button class="w-full mb-3">Hoàn tất đặt hàng</Button>
                </div>
            </div>
        </div>
    </div>

...
<template>
  <div class="mx-7 mt-6">
    <div class="grid">
      <div class="col-9">
        <div class="mx-3 px-3 py-3 bg-white font-medium text-lg">
          Số lượng ({{ objCart.length }})
        </div>

        <div
          v-for="(item, index) in objCart"
          :key="index"
          class="mx-3 mt-4 px-3 py-3 bg-white"
        >
          <div class="flex justify-content-between text-lg">
            ...
            <label for="">
              ...
              <i
                @click="deleteItem(index, objCart)"
